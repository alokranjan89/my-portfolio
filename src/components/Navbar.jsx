      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#home">
            <img
              src={profile}
              alt="Alok Ranjan"
              className="w-10 h-10 rounded-full border-2 border-cyan-400 shrink-0 hover:scale-105 transition"
            />
          </a>
          ...
          <a
            href="#about"
            className="text-lg font-bold text-white whitespace-nowrap hover:text-cyan-400 transition"
          >
        ...
        <nav className="hidden md:flex items-center gap-8 text-gray-300">
          ...
          <a
            ...
            download
            className="ml-4 px-5 py-2 rounded-lg bg-cyan-400 text-black font-semibold hover:bg-cyan-300 transition"
          >
            Resume
          </a>
        </nav>
